...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d96135b6.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-5e1fe644.css"],
      js: [assets + "/_app/start-d96135b6.js", assets + "/_app/chunks/vendor-97b30f26.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 53477, "type": "image/png" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }, { "file": "svelte-welcome.png", "size": 360807, "type": "image/png" }, { "file": "svelte-welcome.webp", "size": 115470, "type": "image/webp" }],
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-35f2b655.js", "css": ["assets/vendor-5e1fe644.css"], "js": ["layout.svelte-35f2b655.js", "chunks/vendor-97b30f26.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-5a241024.js", "css": ["assets/vendor-5e1fe644.css"], "js": ["error.svelte-5a241024.js", "chunks/vendor-97b30f26.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-00066d39.js", "css": ["assets/pages/index.svelte-b7e962b8.css", "assets/vendor-5e1fe644.css"], "js": ["pages/index.svelte-00066d39.js", "chunks/vendor-97b30f26.js"], "styles": [] } };
...
var css$3 = {
  code: "input.svelte-jm1h{border-radius:5px;padding:0.5rem 1rem;margin-bottom:1rem;border:1px solid #ff3e0080}input.svelte-jm1h:focus-visible{outline:none;border:2px solid #FF3E00}",
  map: `{"version":3,"file":"Search.svelte","sources":["Search.svelte"],"sourcesContent":["<script>\\n    import { createEventDispatcher } from 'svelte';\\n    const dispatch = createEventDispatcher();\\n\\n\\n    export let searchedValue = '';\\n\\n    function search() {\\n        dispatch('search', {\\n            searchedValue\\n        })\\n    }\\n<\/script>\\n\\n<input on:keyup=\\"{search}\\" bind:value=\\"{searchedValue}\\" type=\\"text\\" placeholder=\\"AAPL\\">\\n\\n<style>\\n    input {\\n        border-radius: 5px;\\n        padding: 0.5rem 1rem;\\n        margin-bottom: 1rem;\\n        border: 1px solid #ff3e0080;\\n    }\\n\\n    input:focus-visible {\\n        outline: none;\\n        border: 2px solid #FF3E00;\\n    }\\n\\n</style>"],"names":[],"mappings":"AAiBI,KAAK,YAAC,CAAC,AACH,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,MAAM,CAAC,IAAI,CACpB,aAAa,CAAE,IAAI,CACnB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,SAAS,AAC/B,CAAC,AAED,iBAAK,cAAc,AAAC,CAAC,AACjB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAC7B,CAAC"}`
};
var Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<input type="${"text"}" placeholder="${"AAPL"}" class="${"svelte-jm1h"}"${add_attribute("value", searchedValue, 0)}>`;
});
var css$2 = {
